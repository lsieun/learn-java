...
public class SHA1Utils {
    ...
    public static byte[] sha1_hash(byte[] input, int len) {
        ...
        if (remainder >= SHA1Const.SHA1_INPUT_BLOCK_SIZE) {
            Arrays.fill(input_block, (byte) 0);
    ...
    public static void fill_length_in_bits(byte[] input_block, int length_in_bits) {
        input_block[MD5Const.MD5_BLOCK_SIZE - 4] = (byte) ((length_in_bits & 0xFF000000) >> 24);
        input_block[MD5Const.MD5_BLOCK_SIZE - 3] = (byte) ((length_in_bits & 0x00FF0000) >> 16);
        input_block[MD5Const.MD5_BLOCK_SIZE - 2] = (byte) ((length_in_bits & 0x0000FF00) >> 8);
        input_block[MD5Const.MD5_BLOCK_SIZE - 1] = (byte) (length_in_bits & 0x000000FF);
    }
