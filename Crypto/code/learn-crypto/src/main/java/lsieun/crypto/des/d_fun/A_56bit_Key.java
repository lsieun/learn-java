package lsieun.crypto.des.d_fun;

import lsieun.crypto.des.CipherType;
import lsieun.crypto.des.DES;
...
public class A_56bit_Key {
    public static void main(String[] args) {
        ...
        // 使用不同的密钥进行加密
        byte[] encrypt_bytes1 = DES.des_block_operate(msg_64_bit_bytes, key_64_bit_bytes1, CipherType.ENCRYPT);
        byte[] encrypt_bytes2 = DES.des_block_operate(msg_64_bit_bytes, key_64_bit_bytes2, CipherType.ENCRYPT);
