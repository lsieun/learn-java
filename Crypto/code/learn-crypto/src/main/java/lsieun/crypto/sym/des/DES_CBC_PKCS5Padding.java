...
public class DES_CBC_PKCS5Padding {
    ...
    public static byte[] des_cbc_encrypt(byte[] input, byte[] key_64_bit_bytes, byte[] iv_64_bit_bytes) {
        ...
        return des_cbc_operate(padded_input, key_64_bit_bytes, iv_64_bit_bytes, CipherType.ENCRYPT);
    }

    public static byte[] des_cbc_decrypt(byte[] input, byte[] key_64_bit_bytes, byte[] iv_64_bit_bytes) {
        byte[] decrypted_bytes = des_cbc_operate(input, key_64_bit_bytes, iv_64_bit_bytes, CipherType.DECRYPT);
        return PaddingUtils.remove_pkcs5_padding(decrypted_bytes);
    }

    @SuppressWarnings("Duplicates")
    public static byte[] des_cbc_operate(byte[] input, byte[] key_64_bit_bytes, byte[] iv_64_bit_bytes, CipherType operation) {
