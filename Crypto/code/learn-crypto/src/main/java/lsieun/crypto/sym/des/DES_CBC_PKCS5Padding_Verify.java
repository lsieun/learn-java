...
public class DES_CBC_PKCS5Padding_Verify {
    public static void main(String[] args) throws Exception {
        ...
        byte[] key_bytes = "password".getBytes(StandardCharsets.UTF_8);
        ...
        byte[] encrypted_bytes2 = DES_CBC_PKCS5Padding.des_encrypt(plain_text_bytes, key_bytes, initialization_vector_bytes);
        ...
        byte[] decrypted_bytes2 = DES_CBC_PKCS5Padding.des_decrypt(encrypted_bytes1, key_bytes, initialization_vector_bytes);
