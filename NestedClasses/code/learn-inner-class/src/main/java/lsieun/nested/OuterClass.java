...
public class OuterClass {
    ...
    // static nested class
    // can access OuterClass static variables/methods
    ...
    // inner class
    // non-static and can access all the variables/methods of outer class
    class InnerClass {
        private int w;
        protected  int x;
        int y;
    ...
    public String[] getFilesInDir(String dir, final String ext) {
        ...
        // anonymous inner class implementing Filename Filter interface
