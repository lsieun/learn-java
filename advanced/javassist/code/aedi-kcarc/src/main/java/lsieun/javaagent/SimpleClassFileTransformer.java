...
//                if (findClass(fullyQualifiedClassName, "com.jetbrains.b.b.y")) {
//                    CtClass cc = AssistUtil.getClass(byteCode);
//                    CtMethod[] methods = AssistUtil.findMethods(cc, "a", "(Ljava/lang/String;Ljava/lang/String;J[Lcom/jetbrains/b/b/l;)V", 0);
//                    AssistUtil.catchException(methods);
//                    byteCode = cc.toBytecode();
//                }

//                if (findClass(fullyQualifiedClassName, "com.jetbrains.b.b.D")) {
//                    // byteCode = TicketHandler.obtainTicket(className, byteCode);
...
//            if (findClass(className, "com.intellij.ide.b.h.aY")) {
//                byteCode = catMethod(className, classfileBuffer, "a");
//            }

//            if (findClass(className, "com.intellij.ide.b.h.R")) {
//                byteCode = catMethod(className, classfileBuffer, "f");
//            }

//            if (findClass(className, "com.jetbrains.a.b.Q")) {
//                byteCode = catMethod(className, classfileBuffer, "a", "(Ljava/lang/Object;)Ljava/lang/String;");
//            }

//            if (findClass(className, "com.jetbrains.a.b.d")) {
//                byteCode = catMethod(className, classfileBuffer, "a", "(Ljava/lang/String;Ljava/lang/String;J[Lcom/jetbrains/a/b/s;)V");
//            }

//            findMethodBySignature(className, byteCode, "com.jetbrains", ")Lcom/jetbrains/ls/data/LicenseData;", 1);

            // 2018.2.4 com.jetbrains.a.b.d      (Ljava/lang/String;Ljava/lang/String;J[Lcom/jetbrains/a/b/s;)V
            // 2018.2.5 com.jetbrains.b.b.y      (Ljava/lang/String;Ljava/lang/String;J[Lcom/jetbrains/b/b/l;)V
//            if (findClass(className, "com.jetbrains.b.b.y")) {
//                byteCode = modifyMethod(className, classfileBuffer, "a", "(Ljava/lang/String;Ljava/lang/String;J[Lcom/jetbrains/b/b/l;)V");
//            }

            // 2018.2.4 com.jetbrains.a.b.O
            // 2018.2.5 com.jetbrains.b.b.D

            //byteCode = modifySignatureMethod(className, classfileBuffer);
            
//            if (findClass(className, "com.jetbrains.b.b.D")) {
//                System.out.println("============================");
//                byteCode = TicketHandler.obtainTicket(className, byteCode);
//            }

//            if (findClass(className, "com.jetbrains.a.b.t")) {
//                byteCode = catMethod(className, classfileBuffer, "a", "(Ljava/lang/String;Ljava/lang/String;J)Lcom/jetbrains/a/b/L;");
//            }

            // TODO: u
//            if (findClass(className, "com.jetbrains.a.b.u")) {
//                byteCode = catMethod(className, classfileBuffer, "a", "(Ljava/lang/String;Ljava/lang/String;J)Lcom/jetbrains/a/b/L;");
//            }

//            if (findClass(className, "com.jetbrains.a.b.v")) {
//                byteCode = catMethod(className, classfileBuffer, "a", "(Ljava/lang/String;Ljava/lang/String;J)Lcom/jetbrains/a/b/L;");
//            }
//
//            if (findClass(className, "com.jetbrains.a.b.w")) {
//                byteCode = catMethod(className, classfileBuffer, "a", "(Ljava/lang/String;Ljava/lang/String;J)Lcom/jetbrains/a/b/L;");
//            }
//            if (findClass(className, "com.intellij.ide.b.h.aJ")) {
//                byteCode = catConstructor(className, classfileBuffer);
//            }

            //if (findClass(className, "com.intellij.ide.b.h.aW")) {
                //byteCode = catMethod(className, classfileBuffer, "a");
            //}
        }
        catch (Exception ex) {
