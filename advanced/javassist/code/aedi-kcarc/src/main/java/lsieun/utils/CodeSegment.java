...
public class CodeSegment {
    ...
    public void printMethodInfo(boolean signature, boolean arguments, boolean stackTrace) {
        this.printMethodInfo();
        if(signature) {
            this.printSignature();
        }
        if(arguments) {
    ...
    public void printMethodInfo() {
        this.sb.append("    System.out.println(\"Method Class: \" + $class);");
