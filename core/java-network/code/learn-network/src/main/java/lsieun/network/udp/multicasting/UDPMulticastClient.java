...
public class UDPMulticastClient {
    ...
    public UDPMulticastClient() {
        ...
        try {
            ...
            while(true) {
                multicastSocket.receive(packt);
                String message = new String(packt.getData(), 0, packt.getLength());
                System.out.println("Message from: " + packt.getAddress() + " Message: [" + message + "]");
            }
        }
